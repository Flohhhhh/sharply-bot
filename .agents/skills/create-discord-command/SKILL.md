...
description: Create and update Discord slash commands for this Node.js + TypeScript + discord.js v14 template. Use when the request involves adding a new command, changing command options/subcommands, refactoring command behavior, or fixing command typing/execution in files under src/commands/.
---
...
- Run `npm run check`.
- Run `npm run deploy-commands` (or `npm run deploy-commands -- --global` when explicitly requested).
